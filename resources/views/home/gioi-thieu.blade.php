...
@section('title', 'Giới Thiệu Trung Tâm - Gia Sư Tri Thức')
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; align-items: center; margin-bottom: 4rem;">
        <div>
            ...
            <p style="font-size: 0.98rem; color: #475569; line-height: 1.8; margin-bottom: 1rem;">
                Gia Sư Tri Thức được điều hành trực tiếp bởi ông <strong>Đào Bình Phước</strong>, áp dụng quy trình kiểm duyệt hồ sơ 3 lớp nghiêm ngặt: Thẻ sinh viên / Bằng cấp chuyên môn -> Thẩm định hồ sơ -> Đánh giá trải nghiệm thực tế từ phụ huynh.
            </p>
